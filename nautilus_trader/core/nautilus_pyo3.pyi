...
class MarketResilienceIndicator:
    def __init__(
        self,
        timeout_ms: int | None = ...,
        spread_window_size: int | None = ...,
        levels_to_consume: int | None = ...,
        spread_increase_threshold: float | None = ...,
        strong_resilience_threshold: float | None = ...,
        weak_resilience_threshold: float | None = ...,
        time_weight: float | None = ...,
        depth_weight: float | None = ...,
        spread_weight: float | None = ...,
        same_side_bias: float | None = ...,
        opposite_side_bias: float | None = ...,
    ) -> None: ...
    @property
    def name(self) -> str: ...
    @property
    ...
    @property
    def bias_side(self) -> str: ...
    @property
    def depletion_side(self) -> str: ...
    @property
    def recovery_side(self) -> str: ...
    @property
